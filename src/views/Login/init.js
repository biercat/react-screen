export default function initLoginBg() {
  ...
  var canvas = document.getElementById('canvas'), ctx = canvas.getContext('2d'), w = canvas.width = windowWidth, h = canvas.height = windowHeight, hue = 217, stars = [], count = 0, maxStars = 1500; //星星数量
